...
def is_armstrong(n):
    ...
    num_str = str(abs(n))  # Ensure it works for negative numbers
...
def classify_number():
    ...
    try:
        num = int(num)  # Convert to an integer, allowing negative numbers
    ...
    response_data = {
        ...
        "digit_sum": sum(map(int, str(abs(num)))),  # Sum of digits
